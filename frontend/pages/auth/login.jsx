            ...
            <div className="divide-y divide-gray-200">
              ...
              >
                ...
                <div className="relative pb-3">
                  ...
                  <input
                    type="text"
                    className="mt-3 peer placeholder-transparent h-12 p-3 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600"
                ...
                <div className="relative">
                  <label
                    htmlFor="password"
                    className="pb-1 absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"
                  >
                    Password
                  </label>
                  <input
